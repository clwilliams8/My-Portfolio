(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["portfolio/attendIT.njk"] = (function() {
...
tasks.push(
function(callback) {
env.getTemplate("../../../public/partials/headPortfolioDetail.html", false, "portfolio/attendIT.njk", false, function(t_2,t_1) {
...
tasks.push(
function(callback) {
env.getTemplate("../../../public/partials/header-socialLinks.html", false, "portfolio/attendIT.njk", false, function(t_6,t_5) {
...
tasks.push(
function(callback) {
env.getTemplate("../../../public/partials/sidebar-footer.html", false, "portfolio/attendIT.njk", false, function(t_10,t_9) {
...
tasks.push(
function(callback) {
env.getTemplate("../../../public/partials/scripts.html", false, "portfolio/attendIT.njk", false, function(t_14,t_13) {
