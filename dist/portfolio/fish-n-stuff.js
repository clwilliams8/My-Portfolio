(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["portfolio/fish-n-stuff.njk"] = (function() {
...
tasks.push(
function(callback) {
env.getTemplate("../../../public/partials/headPortfolioDetail.html", false, "portfolio/fish-n-stuff.njk", false, function(t_2,t_1) {
...
tasks.push(
function(callback) {
env.getTemplate("../../../public/partials/header-socialLinks.html", false, "portfolio/fish-n-stuff.njk", false, function(t_6,t_5) {
...
tasks.push(
function(callback) {
env.getTemplate("../../../public/partials/scripts.html", false, "portfolio/fish-n-stuff.njk", false, function(t_14,t_13) {
